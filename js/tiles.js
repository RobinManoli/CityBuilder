...
tileTypeData.City = { icon:true, hidden:true, work:9, buildsOnTopOf:['Plains', 'City'], requiredTiles:{ Village:2, School:2 }, createdFx:{ Population:3, Pollution:1 }, fx:{ Garbage:2 } };
