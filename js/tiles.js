...
tileTypeData.School = { icon:true, hidden:true, work:1, buildsOnTopOf:['Plains'], requiredTiles:{ Village:1 }, createdFx:{ Science:1 }, fx:{ Science:1, Work:-1 } };
tileTypeData.City = { icon:true, hidden:true, work:3, buildsOnTopOf:['Plains', 'City'], requiredTiles:{ Village:2, School:2 }, createdFx:{ Population:3, Pollution:1 }, fx:{ Garbage:3 } };
